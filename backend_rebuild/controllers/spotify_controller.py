...
class SpotifyController:
    ...
    @staticmethod
    def get_spotify_popularity(artist_id, date_end, range):
        # validate
        if not artist_id or not date_end or not range:
            return jsonify({
                "err": "Missing required parameters"
        ...
        try:
            result = SpotifyService.get_chart_popularity(
                user=user,
                artist_id=artist_id,
                date_end=date_end,
                range_key=range
    ...
    @staticmethod
    def get_spotify_fan_conversion_rate(artist_id, date_end, range):
        # validate
        if not artist_id or not date_end or not range:
            return jsonify({
                "err": "Missing required parameters"
        ...
        try:
            result = SpotifyService.get_chart_fan_conversion_rate(
                user=user,
                artist_id=artist_id,
                date_end=date_end,
                range_key=range
    ...
    @staticmethod
    def get_spotify_top_five_city(artist_id):
        # validate
        if not artist_id :
            return jsonify({
                "err": "Missing required parameters"
        ...
        try:
            result = SpotifyService.get_chart_top_city(
                user=user,
                artist_id=artist_id
            )
        except ValueError as e:
    ...
    @staticmethod
    def get_spotify_top_track_by_region(artist_id, country):
        # validate
        if not artist_id or not country:
            return jsonify({
                "err": "Missing required parameters"
            }), 400
        ...
        try:
            result = SpotifyService.get_chart_top_track_by_region(
                user=user,
                artist_id=artist_id,
                country=country
            )
    ...
    @staticmethod
    def get_spotify_top_track_by_country(artist_id, country):
        # validate
        if not artist_id or not country:
            return jsonify({
                "err": "Missing required parameters"
        ...
        try:
            result = SpotifyService.get_chart_top_track_by_country(
                user=user,
                artist_id=artist_id,
                country=country
            )
