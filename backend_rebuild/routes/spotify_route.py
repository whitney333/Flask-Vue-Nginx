...
@spotify_bp.route('/spotify/popularity/<string:artist_id>/<string:date_end>/<string:filter>', methods=['GET'])
...
@spotify_bp.route('/spotify/conversion_rate/<string:artist_id>/<string:date_end>/<string:filter>', methods=['GET'])
