    ...
    >
      <template v-slot:title>
        <div class="flex w-full items-center justify-between">
            <span class="text-h4">{{ $t('Posts') }}</span>
          ...
          <v-card class="rounded-xl p-6 h-full">
            <v-card-item>
              <v-card-title class="text-base sm:text-lg font-semibold">
                {{ $t('Campaign ID') }}: {{ campaign.campaign_id }}
              </v-card-title>
              <v-card-subtitle class="text-xs sm:text-sm text-gray-600">
                {{ $t('Created at')}}: {{ formatDate(campaign.created_at) }}
              </v-card-subtitle>
            </v-card-item>
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                  <div class="flex items-center  gap-2">
                    ...
                    <span class="font-medium">{{ $t('Platforms') }}:</span>
                  </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="font-medium">{{ $t('Regions') }}:</span>
                  </div>
            ...
            <v-card-actions>
              ...
              <v-dialog v-model="dialog" max-width="700px" transition="dialog-bottom-transition">
                <v-card class="rounded-2xl shadow-lg overflow-hidden">
                  ...
                  <!-- Header -->
                  <div class="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-600 text-white p-5 flex items-center justify-between">
                    <div>
