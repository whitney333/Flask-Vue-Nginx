...
export default {
    ...
    return {
      ...
      headers: [
        ...
        {text: 'Song',
         ...
         align: 'start',
         width: 400},
        {text: 'Total Score', value: 'total_score', width: 100},
        {text: 'Sound Track & Album Score', value: 'soundtrack_album_score', width: 100},
        {text: 'Video Broadcast Score', value: 'video_broadcast_score', width: 100},
        {text: 'Global Vote Score', value: 'global_vote_score', width: 100},
        {text: 'SMS Score', value: 'sms_score', width: 100},
      ],
      year_list: ["2022", "2023"],
      week_list: [
  ...
  methods: {
    async get_default() {
      ...
      this.weekNumber = (Math.ceil(days / 7)) - 3;
      await this.axios.get("http://localhost/api/music-broadcast/music-center/chart?"
        + "year=" + this.year
