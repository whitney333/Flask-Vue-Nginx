      ...
      <v-row justify="end">
        ...
        <v-col cols="12">
          ...
          <div class="month_change_percentage">
            <div class="stat">
              <span class="up"
                    v-if="(((this.latest_listener_count - this.past_month_listener_count)/this.past_month_listener_count)*100)>0">
                    +{{
                  Number((((this.latest_listener_count - this.past_month_listener_count) / this.past_month_listener_count) * 100).toFixed(2)).toLocaleString()
                }}%
              </span>
              <span class="down"
                    v-if="(((this.latest_listener_count - this.past_month_listener_count)/this.past_month_listener_count)*100)<0">
