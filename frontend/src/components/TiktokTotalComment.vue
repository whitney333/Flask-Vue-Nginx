<template>
  <div id="tiktok-total-comment-chart">
    <div class="toolbar">
      <v-row justify="end">
        <v-col cols="12">
...
export default {
  ...
  created() {
    this.get_tiktok_total_comments();
    this.update_data();
  },
  filters: {
