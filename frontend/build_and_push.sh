...
# 標記Docker映像
docker tag mishkan-backend:$version 767397998406.dkr.ecr.ap-northeast-1.amazonaws.com/mishkan:$version

# 推送映像到ECR
docker push 767397998406.dkr.ecr.ap-northeast-1.amazonaws.com/mishkan:$version
